...
class TestDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        img_num = os.path.split(self.image_filenames[index])[-1]
        ...
        return {"num":img_num}, input_lr, input_pan, target
...
if __name__ == '__main__':
    train_set = TestDataset('../../PSData3_Raw/Dataset/GF-2', is_train=True, crop_ratio=2)
    from torch.utils.data import DataLoader
    train_dl = DataLoader(train_set, batch_size=3)
    print(len(train_set))
